...
features:
  ...
  - title: "Phase 3: 나만의 Agent"
    details: "Gateway 확장 + 바이브코딩으로 설계 → 구현 → 배포 → Memory 연동"
    link: /phase3/
---
...
| **Browser** | Mock 사이트에서 실시간 정보 수집 | Phase 2A |

## 워크샵 구조

```mermaid
graph TD
    A["Phase 1: 추천 Agent<br/>Gateway + Runtime + Observability<br/><b>60분</b>"] --> C["Phase 2A: CS Agent<br/>+ Memory + Policy + Browser<br/>★★★ 60분"]
...
| 11:30-12:30 | **Phase 2A** | 어제 온 고객을 기억하는 CS Agent (60분) |
| 12:30-13:30 | 점심 | |
| 13:30-14:30 | **Phase 3** | Tool 등록 + 나만의 Agent 설계·바이브코딩·배포 (60분) |
...
- [ ] **Phase 2A** — Memory + Policy + Browser
