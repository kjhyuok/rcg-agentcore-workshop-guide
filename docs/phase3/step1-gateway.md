...
Phase 2A: cs-lookup-order, cs-return-policy,
...
원하는 Gateway 이름을 입력한 뒤, 워크샵에서는 인바운드 인증 없이 구성하는 옵션을 선택하도록 합니다. 퍼블릭 환경에서는 IAM 권한을 사용하거나 JWT 토큰 사용이 권장됩니다.
![Gateway 인증 추가](gw.png)

그 다음 등록된 rcg-workshop-gw-xxxx의 target에 아래 설정으로 등록합니다:
