# Step 5: Memory로 고도화하기 <span class="badge-time">⏱️ 10분</span> <span class="badge-difficulty">★★☆</span>
...
<div class="step-progress">
  ...
  <span class="step-connector done"></span>
  <span class="step active">● Step 5 Memory</span>
</div>
...
**반드시 실행**: 출력된 export 명령어를 복사 → 붙여넣기
...
Step 2 설계서에 적은 `/promotions/{actorId}/` 같은 커스텀 네임스페이스를 쓰려면
...
## 5-4. Trace에서 Memory 스팬 확인

Observability Dashboard에서 Step 4와 비교해보세요:
