# Step 3: 바이브코딩으로 구현하기 <span class="badge-time">⏱️ 20분</span> <span class="badge-difficulty">★★★</span>
...
<div class="step-progress">
  ...
  <span class="step-connector done"></span>
  <span class="step active">● Step 3 바이브코딩</span>
...
::: info 이 Step의 목표
Step 2의 설계서를 AI 코딩 도구에 전달하여 `agents/phase3/app/phase3/main.py`를 생성합니다.
...
바이브코딩에서 AI에게 시킬 일도 결국 이것입니다 — 구조는 유지, 역할만 교체.
:::
...
4. Memory 연동 코드는 아직 넣지 마. (Step 5에서 추가할 거야)
...
# ║  (Step 5에서 사용 — 지금은 주석만 남겨두세요) ║
# ╚══════════════════════════════════════════════╝
# Memory 연동은 Step 5에서 추가합니다.
...
3. **Memory 주석** — 기억의 주체(actor_id)만 정해두기 (연동은 Step 5에서)
:::
...
체크리스트를 통과하면 바로 Step 4로 — 세부 개선은 배포 후에도 할 수 있습니다.
:::
...
::: tip ✅ 다음
코드 완성! → [Step 4: Runtime 배포 & Playground 테스트](step4-deploy.md)
:::
